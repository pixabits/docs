...
For example, if the current block height was 5000, you'd add 250,000 for the stake withdrawl cooldown period, plus an additional 60 blocks to allow for chain processing delays. Therefore the `stake-release-height` = `5000 + 250000 + 60` or `255060`.
